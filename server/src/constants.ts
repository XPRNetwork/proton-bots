...
export const BOTS_ACCOUNTS: BotAccount[] = [
    ...
    { bot_index: 2, name: 'bot3', permission: 'active', parallel: 10, timer: (86400 / 50000) * 1000, oracle: ORACLES[0] },
    { bot_index: 3, name: 'bot4', permission: 'active', parallel: 100, timer: 5000, oracle: ORACLES[0] },
    ...
    { bot_index: 6, name: 'bot3', permission: 'active', parallel: 10, timer: (86400 / 50000) * 1000, oracle: ORACLES[1]  },
    { bot_index: 7, name: 'bot4', permission: 'active', parallel: 100, timer: 5000, oracle: ORACLES[1]  }
]
