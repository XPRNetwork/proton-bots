...
export const BOTS_ACCOUNTS: BotAccount[] = [
    ...
    { bot_index: 3, name: 'bot4', permission: 'active', parallel: 70, timer: 5000, oracle: ORACLES[0] },
    ...
    { bot_index: 7, name: 'bot4', permission: 'active', parallel: 70, timer: 5000, oracle: ORACLES[1]  }
]
