...
export const BOTS_ACCOUNTS: BotAccount[] = [
    ...
    { bot_index: 2, name: 'bot3', permission: 'active', parallel: 5, timer: (86400 / 50000) * 1000, ...ORACLES[1] },
    { bot_index: 3, name: 'bot4', permission: 'active', parallel: 200, timer: 1000, ...ORACLES[1] }
]
